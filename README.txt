...
1. EMAIL: contact@raoulzenon.com is used everywhere as a placeholder,
   since you don't have a bluemagic-labs.com mailbox yet. Set one up
   (e.g. Google Workspace or your domain registrar's email hosting)
   and replace every instance of contact@raoulzenon.com in:
   contact.html and legal.html.

2. LINKEDIN: company.html has a placeholder "LinkedIn profile →" link
   with href="#". Replace with your real LinkedIn profile URL, or
   remove the line if you'd rather not link it yet.

3. LEGAL/PRIVACY TEXT: The privacy notice and terms on legal.html are
...
4. DEPLOYMENT: Built to deploy as-is on Netlify (drag-and-drop the
...
5. FAVICON: none included. Add one if you want a browser tab icon.
